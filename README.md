...
For complete integration guides and API reference, visit the [Video Editor Documentation](https://img.ly/docs/cesdk/js/starterkits/video-export-options-veo001/).
